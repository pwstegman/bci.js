...
function dpss(length) {
  ...
  vectors = (0, _mathjs.transpose)(vectors); // Compute eigenvalues of the definition equation
  ...
  var all_values = (0, _mathjs.multiply)(q, s); // Select only top K eigenvalues of definition equation
