 ...
 * future updates.
 * @param {number} fftSize - Size of the fourier transform used to compute the PSD.
 * @returns {number} The average power in the frequency band.
 */
function signalBandPower(signal, sampleRate, band, fftSize) {
	var p = psd(signal, fftSize);
