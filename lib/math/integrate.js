 ...
 * @param {string} rule - 'trapz' for trapezoid rule, '1/3' for Simpson's 1/3rd rule, or '3/8' for Simpson's 3/8ths rule. Default is '3/8' as it is generally the most accurate.
 */
function integrate(x, rule='3/8') {
    ...
    // Simpson's 1/3rd rule (needs at least 3 points)
        ...
        if(x.length % 2 == 1) {
            ...
            */
            ...
            return simpsons13(left) + simpsons38(right);
        }
    }
    ...
    // Simpson's 3/8ths rule (needs at least 4 points)
        ...
        // We can split up array to make one segment have the right number and use a fall back method for the remaining
            ...
            return simpsons38(left) + integrate(right);
        }
    }
}
