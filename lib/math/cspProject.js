...
function cspProject(cspParams, data, dimensions) {
  var projected = (0, _mathjs.multiply)(data, cspParams.V); // Default number of dimensions is all of them, which is number of columns in data
