...
* [bcijs](#module_bcijs)
    ...
    * [.welch(signal, sample_rate, options)](#module_bcijs.welch) ⇒ <code>object</code>
...
**Kind**: static property of [<code>bcijs</code>](#module_bcijs)  
...
| [dimension] | <code>string</code> | If 'rows' or 'columns' passed, the features are calculated along that dimension |
...
| [options] | <code>Object</code> |  |  |
| [options.fftSize] | <code>number</code> | <code>Math.pow(2, bci.nextpow2(signal.length))</code> | Size of the fft to be used. Should be a power of 2. |
| [options.window] | <code>string</code> \| <code>Array.&lt;number&gt;</code> | <code>&quot;&#x27;rectangular&#x27;&quot;</code> | Window function to apply, either 'hann', 'rectangular', or an array for a custom window. Default is 'rectangular'. |
...
<a name="module_bcijs.welch"></a>

### bcijs.welch(signal, sample_rate, options) ⇒ <code>object</code>
...
| tail | <code>boolean</code> | If false, windows which begin near the end of the array which cannot reach length 'length' will be ignored |
